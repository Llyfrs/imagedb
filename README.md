...
> ⚠️ Full Disclaimer: this entier project was generated using Cursor. It was just idea I had and it seemed like something AI could do easily. Might properly expand on it if I really enjoy using it. 
...
- Load by text query to clipboard (best match only):  
